...
public class Weapon2 extends NormalWeapon{
    ...
    public void shoot(){
        if(cooldown<=0){
            ...
            shootBullet(pos,velocity.multiply(3),size,health,damage);
            shootBullet(pos,velocity.multiply(2),size*2,health*2,damage*4);
            shootBullet(pos,velocity.multiply(1),size*4,health*6,damage*7);
            cooldown=reload*3;
        }
    }
}
