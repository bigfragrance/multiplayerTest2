package engine.math.util.pathing;
...
public class Calculator {
    public Vec2d from;
    public Vec2d to;
    public double STEP = cs.serverController.blockSize*0.5;
    public long TIMEOUT = 2;
    public long start = 0;
    public int MAXFALLHEIGHT = 320;
    public int MAXSTEPHEIGHT = 3;
    public double VALIDDISTANCE = cs.serverController.blockSize*0.8;
    public boolean BYPASSLIQUID = true;
    public int worldMinY = 0;
    public boolean CENTER = false;
    public ArrayList<Vec2d> TRIED = null;
    public boolean FLYABLE = false;
    public double FLYHITBOXEXPLAN = 1;
    public boolean PLACEBLOCK = false;
    public boolean JUMP = false;
    public double JUMPDISTANCE = 3.5;
    public double JUMPDISTANCEUP = 2.5;
    public Entity owner;
