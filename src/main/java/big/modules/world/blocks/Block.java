package big.modules.world.blocks;
...
import static big.engine.math.util.Util.toMiniMap;
...
public class Block {
    ...
    public void renderMini(Graphics g,BlockState state,int x,int y){
        if(this==Blocks.STONE){
            render(g,Util.toMiniMap(new Box(new BlockPos(x,y))),ColorUtils.setAlpha(Color.DARK_GRAY,100));
        }
    }
