...
public class StringNbtReader {
	...
	public static final Dynamic2CommandExceptionType LIST_MIXED = new Dynamic2CommandExceptionType((receivedType, expectedType) -> {
		return Text.stringifiedTranslatable("argument.nbt.list.mixed", receivedType, expectedType);
	});
	public static final Dynamic2CommandExceptionType ARRAY_MIXED = new Dynamic2CommandExceptionType((receivedType, expectedType) -> {
		return Text.stringifiedTranslatable("argument.nbt.array.mixed", receivedType, expectedType);
	});
	public static final DynamicCommandExceptionType ARRAY_INVALID = new DynamicCommandExceptionType((type) -> {
		return Text.stringifiedTranslatable("argument.nbt.array.invalid", type);
	});
	...
	public static final Codec<NbtCompound> STRINGIFIED_CODEC;
	public static final Codec<NbtCompound> NBT_COMPOUND_CODEC;
	...
	static {
		STRINGIFIED_CODEC = Codec.STRING.comapFlatMap((nbt) -> {
			try {
